const menu = [ //Menù completo 11/08/2025
    ...
    },
    {
        categoria: "Bevande",
        prodotti: [
            { nome: "Acqua 1/2 litro naturale", prezzo: 1, immagine: "img/bevande/acquanat12.png", allergeni: [] },
            { nome: "Acqua 1/2 litro frizzante", prezzo: 1, immagine: "img/bevande/acquafrizz12.png", allergeni: [] },
            { nome: "Acqua 1 litro naturale", prezzo: 2, immagine: "img/bevande/acquanat1.png", allergeni: [] },
            { nome: "Acqua 1 litro frizzante", prezzo: 2, immagine: "img/bevande/acquafrizz1.png", allergeni: [] },
            { nome: "Succo di frutta ACE", prezzo: 2, immagine: "img/bevande/succoace.png", allergeni: [] },
            { nome: "Succo di frutta albicocca", prezzo: 2, immagine: "img/bevande/succoalb.png", allergeni: [] },
            { nome: "Succo di frutta pesca", prezzo: 2, immagine: "img/bevande/succopesca.png", allergeni: [] },
            { nome: "Succo di frutta mirtillo", prezzo: 2, immagine: "img/bevande/succomirt.png", allergeni: [] },
            { nome: "Succo di frutta pera", prezzo: 2, immagine: "img/bevande/succopera.png", allergeni: [] },
            { nome: "Sanbitter (liscio)", prezzo: 2.50, immagine: "img/bevande/bitter.png", allergeni: [] },
            { nome: "Crodino (liscio)", prezzo: 2.50, immagine: "img/bevande/crodino.png", allergeni: [] },
            ...
            { nome: "Coca in bottiglia", prezzo: 2.5, immagine: "img/bevande/cocabott.png", allergeni: [] },
            { nome: "Coca zero in bottiglia", prezzo: 2.5, immagine: "img/bevande/cocazerobott.png", allergeni: [] },
            { nome: "Fanta in bottiglia", prezzo: 2.5, immagine: "img/bevande/fantabott.png", allergeni: [] },
            { nome: "Sprite in bottiglia", prezzo: 2.5, immagine: "img/bevande/spritebott.png", allergeni: [] },
            { nome: "Schweppes in bottiglia", prezzo: 2.50, immagine: "img/bevande/tonica.png", allergeni: [] },
            { nome: "Lemon in bottiglia", prezzo: 2.50, immagine: "img/bevande/lemon.png", allergeni: [] },
            { nome: "Chinotto in bottiglia", prezzo: 2.5, immagine: "img/bevande/chinotto.png", allergeni: [] },
            { nome: "Cedrata in bottiglia", prezzo: 2.5, immagine: "img/bevande/cedrata.png", allergeni: [] },
            ...
            { nome: "Birra analcolica", prezzo: 3.5, immagine: "img/bevande/birranal.png", allergeni: [] },
        ]
    },
    {
        categoria: "Bevande alcoliche",
        prodotti: [
            { nome: "Vino (bottiglia, calice)", prezzo: 3.5, descrizione: "scegli tu il tipo. <b><br>Il prezzo può variare</p></b>", immagine: "img/bevande/vinorosso.png", allergeni: [] },
            { nome: "Sanbitter (corretto)", prezzo: 3, immagine: "img/bevande/bitter.png", allergeni: [] },
            { nome: "Crodino (corretto)", prezzo: 3, immagine: "img/bevande/crodino.png", allergeni: [] },
            { nome: "Campari Soda (corretto)", prezzo: 3.50, immagine: "img/bevande/campari.png", allergeni: [] },
            { nome: "Birra alla spina (piccola)", prezzo: 2.5, immagine: "img/bevande/birrapiccola.png", allergeni: [] },
            { nome: "Birra alla spina (media)", prezzo: 3.5, immagine: "img/bevande/birragrande.png", allergeni: [] },
            { nome: "Birra Corona", prezzo: 2.5, immagine: "img/bevande/corona.png", allergeni: [] },
            { nome: "Birra Moretti", prezzo: 2.5, immagine: "img/bevande/birramoretti.png", allergeni: [] },
            { nome: "Birra Icnusa non filtata", prezzo: 3.5, immagine: "img/bevande/birraichnusa.png", allergeni: [] },
            { nome: "Birra Becks", prezzo: 2.5, immagine: "img/bevande/birrabecks.png", allergeni: [] },
            { nome: "Birra Ceres", prezzo: 3.5, immagine: "img/bevande/birraceres.png", allergeni: [] },
    ...
    },
    {
        categoria: "Cocktail",
        prodotti: [
            { nome: "Aperol Spritz", prezzo: 4, immagine: "img/bevande/aperolspritz.png", allergeni: [] },
